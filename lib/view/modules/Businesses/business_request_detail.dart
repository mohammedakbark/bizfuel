...
class RequestDeatilOfBusiness extends StatelessWidget {
  String requestId;
  RequestDeatilOfBusiness({super.key, required this.requestId});
            ...
            builder: (context, snapshot) {
              ...
              return FutureBuilder(
                  future: FirebaseHelper()
                      .getSelectedReSellerProfile(requestModel.sendeId),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      return Helper.showIndicator();
                    }
                    UserRegModel businesRegistrationModel =
                    ...
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          boxtile(businesRegistrationModel.name),
                          const SizedBox(
                            height: 20,
                          ),
                          ...
                          boxtile(businesRegistrationModel.qualification),
                          const SizedBox(
                            height: 20,
                          ),
                          Row(
